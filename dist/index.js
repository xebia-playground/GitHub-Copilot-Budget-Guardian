...
`;
        ...
        logger2.success("artifacts/budget-report.md generated.");
        logger2.success("artifacts/budget-report.json generated.");
        logger2.success("artifacts/budget-report.csv generated.");
      }
      /**
      ...
      async writeJobSummary(result, context = {}) {
        ...
        logger2.success("GitHub Job Summary written.");
      }
    };
...
var require_sync_service = __commonJS({
  "src/sync-service.js"(exports2, module2) {
    ...
    var reportService2 = require_report_service();
    var SyncService2 = class {
      async sync(budgets, githubClient, config2) {
        ...
        if (githubClient && config2.enterpriseSlug) {
          try {
            logger2.info(
              `Enterprise Slug: ${config2.enterpriseSlug}`
            );
...
var require_email_service = __commonJS({
  "src/services/email-service.js"(exports2, module2) {
    var fs = require("fs");
    var path = require("path");
    var logger2 = require_logger();
    async function sendEmail(context, result) {
      ...
      const nodemailer = require_nodemailer();
...
var require_utils = __commonJS({
  "src/utils.js"(exports2, module2) {
    ...
    module2.exports = { postJson };
  }
});

// src/services/teams-service.js
var require_teams_service = __commonJS({
  "src/services/teams-service.js"(exports2, module2) {
    var logger2 = require_logger();
    ...
    module2.exports = { sendTeams };
  }
});

// src/services/slack-service.js
var require_slack_service = __commonJS({
  "src/services/slack-service.js"(exports2, module2) {
    var logger2 = require_logger();
    var { postJson } = require_utils();
...
${changedUsersText}`
      ...
      logger2.success("Slack notification sent.");
    }
    module2.exports = { sendSlack };
  }
});

// src/services/notification-service.js
var require_notification_service = __commonJS({
  "src/services/notification-service.js"(exports2, module2) {
    var logger2 = require_logger();
    ...
    async function runNotifications2(context, result, notifyOn) {
      ...
      logger2.startGroup("Notifications");
      const channels = [
    ...
    module2.exports = { runNotifications: runNotifications2 };
  }
});
...
var { runNotifications } = require_notification_service();
async function run() {
  try {
